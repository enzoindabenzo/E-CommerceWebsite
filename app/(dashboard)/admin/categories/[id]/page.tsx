  ...
  return (
    <div className="bg-white flex justify-start max-w-screen-2xl mx-auto xl:h-full max-xl:flex-col max-xl:gap-y-5">
      ...
      <div className="flex flex-col gap-y-7 xl:pl-5 max-xl:px-5 w-full">
        <h1 className="text-3xl font-semibold">Detajet e kategorisë</h1>
        <div>
          <label className="form-control w-full max-w-xs">
            <div className="label">
              <span className="label-text">Emri i kategorisë:</span>
            </div>
            <input
              type="text"
        ...
        <p className="text-xl text-error max-sm:text-lg">
          Shënim: Nëse fshini këtë kategori, do të fshini të gjitha produktet e lidhura me kategorinë.
        </p>
      </div>
    </div>
  );
